...
@WebServlet(name="viewEmployeesServlet", value="/viewAllEmployees")
public class viewAllEmployeesServlet extends Servlet{
    /**
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            if (isManager()) {
                // Do manager stuff
                List<Employee> employees = managerService.viewAllEmployees();
                response = new ViewAllEmployeesResponse(resp, employees);
            }
            // If not a manager
            else {
                // Not authorized
